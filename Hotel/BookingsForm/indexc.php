        ...
        <div class="top-container mb-8">
            <div class="hotel-content justify-center ">
                <div class="hotel-name flex justify-between ">
                    <div>
                        <h1 class="text-4xl text-left font-black top-text mb-6 ">Club Suite</h1>
                        <div class="flex justify-between">
                            <p>
                            <div class="text-left">
                            A spacious haven for stylish hosting
                            </div>
