...
$email = $row['email'];
$disp =  'booking confirmed';

if (isset($_POST['book'])) {

$name = $_SESSION['id'];
$age = $_POST['age'];
$book_name = 'Burj Two Bedroom Family Suite';
$sql = "UPDATE sign SET age='{$age}', book_name='{$book_name}' WHERE name='{$name}'";
...
<head>
    ...
    <script src="../Bookings Form/index.js"></script>
...
<?php echo $disp; ?>
    ...
    <form id="form">
        <div class="top-container mb-8">
            <div class="hotel-content justify-center ">
                <div class="hotel-name flex justify-between ">
                    <div>
                        <h1 class="text-4xl text-left font-black top-text mb-6 ">Burj Two Bedroom Family Suite</h1>
                        <div class="flex justify-between">
                            <p>
                            <div class="text-left">
                            Family comfort with space and style
                            </div>
                            <div class="flex mb-1 ml-12">
                                <span class="flex items-center">
                                    ...
                                    <span class="text-gray-600 text-xs">4 Reviews</span>
                                </span>
                            </div>
                            </p>
                        </div>
                    ...
                    <img class="object-cover h-40 w-80 rounded-md mr-4 shadow-md shadow-black "
                        src="images/deluxCity.jpeg" alt="">
                </div>
            </div>
        </div>
        ...
        <div>
            <div class="text-left mb-8">
                <h1 class="text-xl font-black mb-3">Price Includes</h1>
                <ul class="pl-4">


                    <div class="flex mb-1">
                        <img class="w-6 mr-2" src="images/icons8-check-64.png" alt="" />
                        <li>
                            No meals included
                        </li>
                    </div>
    ...
    <form action="" method="post">
        ...
        <div class="flex">
            <h1 class="text-4xl">Rs. 8500/-</h1>
            <button type="submit" name="book" value=""
                class="flex ml-auto text-white bg-indigo-500 border-0 static py-4 px-16 focus:outline-none hover:bg-indigo-600 rounded">
                Book
            </button>
        </div>
    </form>
